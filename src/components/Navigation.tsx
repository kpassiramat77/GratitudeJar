  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 p-4 bg-white/80 backdrop-blur-sm border-t">
      <Tabs value={currentPath} className="w-full max-w-md mx-auto">
        <TabsList className="grid w-full grid-cols-4 bg-purple-50/50">
          <TabsTrigger
            value="/"
            onClick={() => navigate("/")}
            className="data-[state=active]:bg-purple-100 hover:bg-purple-50 flex flex-col items-center gap-1 py-2 text-purple-700"
          >
